...
gdjs.MenuCode.GDsign2Objects1= [];
gdjs.MenuCode.GDsign2Objects2= [];
gdjs.MenuCode.GDsign2Objects3= [];
...
gdjs.MenuCode.GDHighscoreObjects3= [];
...
gdjs.MenuCode.GDBack3Objects1= [];
gdjs.MenuCode.GDBack3Objects2= [];
gdjs.MenuCode.GDBack3Objects3= [];
gdjs.MenuCode.GDHighScoreTitleObjects1= [];
gdjs.MenuCode.GDHighScoreTitleObjects2= [];
gdjs.MenuCode.GDHighScoreTitleObjects3= [];
...
gdjs.MenuCode.GDSumTimeObjects1= [];
gdjs.MenuCode.GDSumTimeObjects2= [];
gdjs.MenuCode.GDSumTimeObjects3= [];
gdjs.MenuCode.GDTimeLeaderboardObjects1= [];
gdjs.MenuCode.GDTimeLeaderboardObjects2= [];
gdjs.MenuCode.GDTimeLeaderboardObjects3= [];
gdjs.MenuCode.GDcover2Objects1= [];
gdjs.MenuCode.GDcover2Objects2= [];
gdjs.MenuCode.GDcover2Objects3= [];
gdjs.MenuCode.GDcover3Objects1= [];
gdjs.MenuCode.GDcover3Objects2= [];
gdjs.MenuCode.GDcover3Objects3= [];
gdjs.MenuCode.GDcover4Objects1= [];
gdjs.MenuCode.GDcover4Objects2= [];
gdjs.MenuCode.GDcover4Objects3= [];
gdjs.MenuCode.GDcoverObjects1= [];
gdjs.MenuCode.GDcoverObjects2= [];
gdjs.MenuCode.GDcoverObjects3= [];
...
gdjs.MenuCode.GDHighscoreObjects2.createFrom(runtimeScene.getObjects("Highscore"));

gdjs.MenuCode.condition0IsTrue_0.val = false;
gdjs.MenuCode.condition1IsTrue_0.val = false;
{
gdjs.MenuCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.MenuCode.mapOfGDgdjs_46MenuCode_46GDHighscoreObjects2Objects, runtimeScene, true, false);
}if ( gdjs.MenuCode.condition0IsTrue_0.val ) {
{
gdjs.MenuCode.condition1IsTrue_0.val = gdjs.evtTools.camera.layerIsVisible(runtimeScene, "");
}}
if (gdjs.MenuCode.condition1IsTrue_0.val) {
{gdjs.evtTools.camera.showLayer(runtimeScene, "HighScore");
}{gdjs.evtTools.camera.hideLayer(runtimeScene, "");
}{gdjs.evtTools.camera.hideLayer(runtimeScene, "Cheats");
}}
...
gdjs.MenuCode.GDBack3Objects2.createFrom(runtimeScene.getObjects("Back3"));

gdjs.MenuCode.condition0IsTrue_0.val = false;
gdjs.MenuCode.condition1IsTrue_0.val = false;
{
gdjs.MenuCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.MenuCode.mapOfGDgdjs_46MenuCode_46GDBack3Objects2Objects, runtimeScene, true, false);
}if ( gdjs.MenuCode.condition0IsTrue_0.val ) {
{
gdjs.MenuCode.condition1IsTrue_0.val = gdjs.evtTools.camera.layerIsVisible(runtimeScene, "HighScore");
}}
if (gdjs.MenuCode.condition1IsTrue_0.val) {
{gdjs.evtTools.camera.showLayer(runtimeScene, "");
}{gdjs.evtTools.camera.hideLayer(runtimeScene, "HighScore");
}{gdjs.evtTools.camera.hideLayer(runtimeScene, "HowToPlay");
}}
...
{gdjs.evtTools.camera.showLayer(runtimeScene, "Background");
    ...
    gdjs.MenuCode.GDHScoreObjects1[i].setString("" + gdjs.evtTools.common.toString(gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0))));
}
}}
...
gdjs.MenuCode.condition0IsTrue_0.val = false;
{
gdjs.MenuCode.condition0IsTrue_0.val = gdjs.evtTools.storage.elementExistsInJSONFile("save", "high_score");
}if (gdjs.MenuCode.condition0IsTrue_0.val) {
...
gdjs.MenuCode.GDHScoreObjects1.createFrom(runtimeScene.getObjects("HScore"));
{for(var i = 0, len = gdjs.MenuCode.GDHScoreObjects1.length ;i < len;++i) {
    gdjs.MenuCode.GDHScoreObjects1[i].setString("Yours     " + gdjs.evtTools.common.toString(gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0))));
}
}}
...
{
gdjs.MenuCode.GDSumTimeObjects1.createFrom(runtimeScene.getObjects("SumTime"));
{for(var i = 0, len = gdjs.MenuCode.GDSumTimeObjects1.length ;i < len;++i) {
    gdjs.MenuCode.GDSumTimeObjects1[i].setString("Yours     " + gdjs.evtTools.common.toString(gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(2)) + gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().get("Time2"))));
}
}}
...
gdjs.MenuCode.GDsign2Objects1.length = 0;
gdjs.MenuCode.GDsign2Objects2.length = 0;
gdjs.MenuCode.GDsign2Objects3.length = 0;
...
gdjs.MenuCode.GDHighscoreObjects3.length = 0;
...
gdjs.MenuCode.GDBack3Objects1.length = 0;
gdjs.MenuCode.GDBack3Objects2.length = 0;
gdjs.MenuCode.GDBack3Objects3.length = 0;
gdjs.MenuCode.GDHighScoreTitleObjects1.length = 0;
gdjs.MenuCode.GDHighScoreTitleObjects2.length = 0;
gdjs.MenuCode.GDHighScoreTitleObjects3.length = 0;
...
gdjs.MenuCode.GDSumTimeObjects1.length = 0;
gdjs.MenuCode.GDSumTimeObjects2.length = 0;
gdjs.MenuCode.GDSumTimeObjects3.length = 0;
gdjs.MenuCode.GDTimeLeaderboardObjects1.length = 0;
gdjs.MenuCode.GDTimeLeaderboardObjects2.length = 0;
gdjs.MenuCode.GDTimeLeaderboardObjects3.length = 0;
gdjs.MenuCode.GDcover2Objects1.length = 0;
gdjs.MenuCode.GDcover2Objects2.length = 0;
gdjs.MenuCode.GDcover2Objects3.length = 0;
gdjs.MenuCode.GDcover3Objects1.length = 0;
gdjs.MenuCode.GDcover3Objects2.length = 0;
gdjs.MenuCode.GDcover3Objects3.length = 0;
gdjs.MenuCode.GDcover4Objects1.length = 0;
gdjs.MenuCode.GDcover4Objects2.length = 0;
gdjs.MenuCode.GDcover4Objects3.length = 0;
gdjs.MenuCode.GDcoverObjects1.length = 0;
